...
1. **Verify the game actually launches modded, and that the two patches behave.** I can't
   ...
   - The log shows `Craigins Valheim Mod v0.6.5 loaded` and Jotunn initializing (plus
     `Craigins Valheim Instances v0.6.5 loaded` / `Craigins Valheim Stargate v0.6.5 loaded` if
